...
def main():
    ...
    dataset = project.version(1).download("yolov11") # หรือ yolov8 ตามที่ระบบ Roboflow export ให้
    ...
    # ทันทีที่รัน โค้ดจะไปดาวน์โหลดไฟล์ yolo11n.pt มาให้โดยอัตโนมัติครับ
